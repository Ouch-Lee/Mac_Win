...
主端操纵台的功能是精准捕捉并映射操纵者控制指令，力求满足人体工程学设计，避免影响手术医生上肢自由运动。合理的自由度布局能避免复杂的映射策略，使得外科医生直观的进行操作，以减少学习曲线并提高手术的安全可靠性[]，因此master console，末端执行器与人体手臂三者之间自由度分布与极为类似, 如fig2所示。这种布局使得surgeon和master console之间有较好的适配性的同时，又让surgeon能舒适的控制surgical arm。
